...
<footer id="page-footer" class="bg-gray-900 text-white mt-auto border-t border-gray-800">
  <div class="container mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
    ...
    <a href="mailto:info@artunhealthcare.com" class="heartbeat-cta flex items-center gap-2 text-sm bg-[#59CDD1]/15 hover:bg-[#59CDD1] text-[#59CDD1] hover:text-white px-4 py-1.5 rounded-full transition-all duration-300 hover:scale-105">
